    ...
    return (
      <div className="row">
        <div className="col-lg mt-5">
          <Card style={{ width: "18rem", margin: "0 auto", float: "none", marginBottom: "10px" }}>
            <Card.Img src="../../../public/BanhUot.png" />
            <Card.Body style = {{padding : "0"}}>
                <div style={{backgroundColor:"#FFE500"}}> 
                    <Card.Title style ={{marginBottom:"0"}}>Group Name</Card.Title>
                </div>
              <Card.Text style={{backgroundColor:"#48BDFF"}}>
                - Description <br></br>
                - Description <br></br>
                - Description
              </Card.Text>
